                ...
                <div class="flex flex-wrap items-center p-4 sm:p-8 pb-4">
                  <div class="flex items-center mb-4 mr-5 md:mr-10">
                    <div class="w-10 h-10 rounded-full overflow-hidden mr-4">
                      <img
                        src="{{asset('assets/images/blog/author-01.png')}}"
                        alt="image"
                        class="w-full"
                      />
                    </div>
            ...
            <div class="flex flex-wrap -mx-4">
              ...
              <div class="w-full lg:w-4/12 px-4">
                <div>
                  ...
                  <div class="flex flex-wrap -mx-4 mb-8">
                    ...
                    <div class="w-full md:w-1/2 lg:w-full px-4">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets/images/blog/article-author-01.png')}}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                    ...
                    <div class="w-full md:w-1/2 lg:w-full px-4">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets/images/blog/article-author-02.png')}}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                    ...
                    <div class="w-full md:w-1/2 lg:w-full px-4">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets/images/blog/article-author-03.png')}}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                    ...
                    <div class="w-full md:w-1/2 lg:w-full px-4">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets/images/blog/article-author-04.png')}}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                  ...
                  >
                    <img
                      src="{{asset('assets/images/blog/bannder-ad.png')}}"
                      alt="image"
                      class="w-full"
                    />
                  </div>
